...
public class ActivitiSettings extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinner.setPrompt("Тип транспорта");
		...
		spinner2.setPrompt("Направление");
		...
		spinner4.setPrompt("Страна въезда/выезда");
		...
		spinner3.setPrompt("Страна въезда/выезда");
		...
		spinner5.setPrompt("Цель поездки");
		...
		spinner8.setPrompt("Тип доп. документа");
		...
		spinner12.setPrompt("Гражданство");
		...
		spinner13.setPrompt("Гражданство");
		...
		spinner14.setPrompt("Основной документ");
	}
